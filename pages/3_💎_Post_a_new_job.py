...
with st.expander("**⚠️ READ ME ⚠️**"):
    ...
    st.warning("This application is by powered by a Large Language Model (LLMs) and you can use it to generate job posting suggestions. Treat this as a helpful AI assistant that can provide initial ideas for you to refine. Never trust the responses at face value. If in doubt, don't use the given response. ")
